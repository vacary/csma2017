...
\begin{itemize}
\item Pour des précisions relativement élevées (au delà de $10^-4$), les méthodes de Newton lisses sont beaucoup plus performantes pour des systemes multi--corps flexibles.
